...
// ─── Packs Crédits One-Time (V8 Final) ───────────────────────────
export const CREDIT_PACKS = {
  pack_5: {
    ...
    description: "5 crédits Maison Baymora",
    icon: "⚡",
    popular: false,
  },
  pack_15: {
    ...
    description: "15 crédits — idéal pour planifier un week-end",
    icon: "✨",
    popular: true,
  },
  pack_30: {
    ...
    priceEur: 22.99,
    priceCents: 2299,
    stripePriceId: process.env.STRIPE_PRICE_PACK_30 || "price_pack_30",
    description: "30 crédits — l'équivalent d'un mois actif",
    icon: "👑",
    popular: false,
  },
  pack_60: {
    ...
    priceEur: 39.99,
    priceCents: 3999,
    stripePriceId: process.env.STRIPE_PRICE_PACK_60 || "price_pack_60",
    description: "60 crédits — pour planifier plusieurs voyages",
    icon: "🔥",
    popular: true,
  },
  pack_150: {
    ...
    priceEur: 89.99,
    priceCents: 8999,
    stripePriceId: process.env.STRIPE_PRICE_PACK_150 || "price_pack_150",
    description: "150 crédits — pour les voyageurs fréquents",
    icon: "⭐",
    popular: false,
  },
  pack_liberte: {
    ...
    description: "600 crédits — liberté totale pour explorer",
    icon: "💎",
    popular: false,
  },
} as const;
