...
const DEFAULT_REVIEWS: Review[] = [
  {
    ...
    text: "Maya m'a ouvert des adresses que je ne connaissais pas. Week-end à Venise planifié en 3 messages. Hôtel, restos, gondole privée. Accès Membre au Cipriani. Je recommande à 100%.",
    date: "Mars 2026",
    scenario: "Prestige",
  ...
  },
  {
    ...
    text: "Mon week-end à Dubai organisé en 3 messages. Suite au Four Seasons, dîner privé sur la Marina, transfert inclus. Le Cercle vaut chaque centime. Maya connaît mes goûts — elle ne propose jamais deux fois la même adresse.",
    date: "Février 2026",
    scenario: "Signature",
