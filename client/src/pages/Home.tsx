...
const plans = [
  {
    name: "Social Club",
    price: "9,90",
    tagline: "Standard — 15 crédits/mois (≈ 5 parcours)",
    features: [
      "15 crédits / mois",
  ...
  {
    name: "Social Club Illimité",
    price: "29,90",
    tagline: "Crédits sans limite — l'expérience complète",
    features: [
      "Crédits illimités",
  ...
  },
  {
    name: "Club Privé",
    price: "Sur mesure",
    tagline: "Le privilège absolu — Sur invitation",
    comingSoon: true,
    features: [
