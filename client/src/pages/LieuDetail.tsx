...
const LIEUX: Record<string, {
  ...
  "plaza-athenee": {
    ...
    tags: ["Piscine", "Spa", "Suite", "Restaurant etoile", "Bar", "Concierge 24h"],
    pct: 28,
    price: "680€",
    original: "940€",
    stars: 5,
  ...
  "mamounia": {
    ...
    maya_tip: "Le hammam royal est une experience unique — reservez en debut de matinee pour eviter l'affluence. Le bar Churchill est incontournable pour un cocktail au coucher du soleil.",
  },
  "canaves-oia": {
    name: "Canaves Oia",
    type: "Boutique Hotel",
    ...
    maya_tip: "Reservez la Honeymoon Suite pour le coucher de soleil le plus romantique du monde. Le diner au bord de la piscine a debordement avec vue sur la caldeira est une experience unique.",
  },
  "aman-tokyo": {
    name: "Aman Tokyo",
    type: "Urban Resort",
    ...
    maya_tip: "Demandez une chambre orientee nord-ouest pour voir le Mont Fuji au lever du soleil. Le spa Aman est l'un des meilleurs du monde — reservez le hammam japonais.",
  },
  "le-cinq": {
    ...
    quartier: "8e arrondissement",
    country: "France",
    description: "Trois etoiles Michelin dans le cadre somptueux du Four Seasons George V. La quintessence de la gastronomie francaise.",
    longDesc: "Le Cinq est l'un des rares restaurants trois etoiles Michelin de Paris. Dans un cadre versaillais somptueux, le chef Christian Le Squer propose une cuisine francaise d'exception, jouant sur les textures, les saveurs et les emotions. La cave compte plus de 50 000 bouteilles. Une experience gastronomique totale.",
    tags: ["3 etoiles Michelin", "Gastronomie", "Cave", "Degustation", "Accord mets-vins"],
    pct: 22,
    price: "280€",
    original: "360€",
    stars: 5,
    ...
    features: ["Menu degustation", "Accord mets-vins", "Cave privee", "Salon prive", "Vegetarien disponible"],
    maya_tip: "Optez pour le menu degustation avec accords mets-vins pour une experience complete. Reservez au moins 3 semaines a l'avance — les tables du fond offrent plus d'intimite.",
  },
};
