      ...
      <div className="max-w-4xl mx-auto px-4 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: "#8B8D94" }}>Sans engagement, résiliable à tout moment</p>
          </div>
        </div>
              ...
              >
                {plan.badge && (
                  <div
                    ...
                    style={{
                      background: plan.highlight ? "linear-gradient(135deg, #C8A96E, #E8D5A8)" : "rgba(200,169,110,0.12)",
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-baseline gap-1">
                      <span className="text-2xl font-bold" style={{ color: plan.highlight ? "#C8A96E" : "#F0EDE6" }}>
                ...
                <ul className="space-y-2 mb-5">
                  {plan.features.map((f) => (
                    <li key={f} className="flex items-start gap-2 text-sm">
                      <Check size={14} color="#C8A96E" className="flex-shrink-0 mt-0.5" />
