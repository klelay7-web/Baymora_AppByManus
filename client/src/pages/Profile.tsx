    ...
    <div className="min-h-screen">
      ...
      <div className="container max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}>
          <Link href="/ma-fiche">
            <div className="glass-card rounded-xl p-5 flex items-center justify-between cursor-pointer hover:border-gold/40 transition-colors border border-transparent">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gold/10 flex items-center justify-center">
                  <Crown size={18} className="text-gold" />
                </div>
                <div>
                  <h3 className="font-serif font-semibold text-sm">Ma Fiche Complète</h3>
                  <p className="text-xs text-muted-foreground">Morphologie, permis, goûts, famille, clubs...</p>
                </div>
              </div>
              <div className="text-gold text-xs font-medium">+50 BP</div>
            </div>
          </Link>
        </motion.div>
